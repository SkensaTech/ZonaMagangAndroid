...
//        homeIndustri = getLayoutInflater().inflate(R.layout.activity_home_industri, new DrawerLayout(this));
    ...
    public void drawerInit(){
        ...
        final PrimaryDrawerItem item2 = new PrimaryDrawerItem().withIdentifier(2).withIcon(getResources().getDrawable(R.drawable.ic_dashboard_black_24dp)).withName("Notifikasi");
