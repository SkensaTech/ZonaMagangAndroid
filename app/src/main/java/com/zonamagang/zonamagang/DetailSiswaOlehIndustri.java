        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        if (position == 1){
                            Intent intent = new Intent(DetailSiswaOlehIndustri.this,HomeIndustri.class);
                            startActivity(intent);
                            finish();
                        }
                        else if (drawerItem.getIdentifier() == 2){
                            Intent itent = new Intent(DetailSiswaOlehIndustri.this,Notifikasi_Industri.class);
                            startActivity(itent);
                            finish();
                        }
                        else if (drawerItem.getIdentifier() == 3){
                            Intent intent = new Intent(DetailSiswaOlehIndustri.this,AkunIndustri.class);
                            startActivity(intent);
                            finish();
                        }
                        else if (drawerItem.getIdentifier() == 4){
                            Intent intent = new Intent(DetailSiswaOlehIndustri.this,TentangKami.class);
                            startActivity(intent);
                            finish();
                        }
                        return false;
